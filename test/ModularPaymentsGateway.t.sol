...
contract ModularPaymentsGatewayTest is Test {
    ...
    function test_revert_initiateTokenPurchase_invalidSignature() public {
        ...
        // send transaction
        vm.prank(sender);
        vm.expectRevert(abi.encodeWithSelector(PaymentsGatewayExtension.PaymentsGatewayVerificationFailed.selector));
        gateway.initiateTokenPurchase(req, _signature);
    }
    ...
    function test_revert_initiateTokenPurchase_requestExpired() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                PaymentsGatewayExtension.PaymentsGatewayRequestExpired.selector,
                req.expirationTimestamp
            )
        );
        gateway.initiateTokenPurchase(req, _signature);
